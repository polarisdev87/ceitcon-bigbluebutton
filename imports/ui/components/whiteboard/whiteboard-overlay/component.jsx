...
import EraserDrawListener from './eraser-listener/component';
import ElementEraserListener from './element-eraser-listener/component';
...
export default class WhiteboardOverlay extends Component {
  ...
  renderDrawListener(actions) {
    ...
    } if (tool === 'elementEraser') {
      return (
        <ElementEraserListener
          userId={userId}
          whiteboardId={whiteboardId}
          drawSettings={drawSettings}
          actions={actions}
...
WhiteboardOverlay.propTypes = {
  ...
  // Defines a handler to remove DARW_UPDATE and DRAW_START to the server
  removeRelatedAnnotations: PropTypes.func.isRequired,
