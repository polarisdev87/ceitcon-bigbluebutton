...
export default class ElementEraserListener extends Component {
  constructor() {
    super();
  ...
  render() {
    ...
    const pencilDrawStyle = {
      ...
      touchAction: 'none',
      zIndex: MAX_Z_INDEX,
      cursor: `url('${baseName}/resources/images/whiteboard-cursor/elemEraser.png') 2 22, default`,
    };
...
ElementEraserListener.propTypes = {
